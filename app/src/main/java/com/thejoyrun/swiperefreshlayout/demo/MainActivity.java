...
public class MainActivity extends AppCompatActivity {
    ...
    private PullUpSwipeRefreshLayout refresh_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refresh_layout = (PullUpSwipeRefreshLayout) findViewById(R.id.refresh_layout);
        ...
        refresh_layout.setLoadingMode(PullUpSwipeRefreshLayout.LoadingMode.click);
    }
